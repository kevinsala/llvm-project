...
clang -O3 -flto -c $1 -o $replo -mllvm --input-gen-mode=replay_generated $ALLOWED_FUNCS
clang++ ig.cpp vm_obj.cpp vm_values.cpp vm_storage.cpp recorder.cpp -g -std=c++20 -O3 $reco -o $basen.rec -flto -fuse-ld=lld -fno-exceptions -DNDEBUG
clang++ ig.cpp vm_obj.cpp vm_values.cpp vm_storage.cpp recorder.cpp -g -std=c++20 -O3 $reco -o $basen.rec.dbg -flto -fuse-ld=lld -fno-exceptions
