...
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP0]], i32 1, i64 1, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i8 [[STOREDV]], ptr [[TMP1]], align 1
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, i64 [[TMP0]], i32 1, i64 1, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 1
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i32 1, i64 1, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP3:%.*]] = load i8, ptr [[TMP2]], align 1
; CHECK-NEXT:    [[TMP4:%.*]] = zext i8 [[TMP3]] to i64
; CHECK-NEXT:    [[TMP5:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, i64 [[TMP4]], i32 1, i64 1, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP0]], i32 2, i64 2, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i16 [[VAL]], ptr [[TMP1]], align 2
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, i64 [[TMP0]], i32 2, i64 2, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 2
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i32 2, i64 2, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP3:%.*]] = load i16, ptr [[TMP2]], align 2
; CHECK-NEXT:    [[TMP4:%.*]] = zext i16 [[TMP3]] to i64
; CHECK-NEXT:    [[TMP5:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, i64 [[TMP4]], i32 2, i64 2, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP0]], i32 4, i64 4, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i32 [[VAL]], ptr [[TMP1]], align 4
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, i64 [[TMP0]], i32 4, i64 4, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i32 4, i64 4, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4
; CHECK-NEXT:    [[TMP4:%.*]] = zext i32 [[TMP3]] to i64
; CHECK-NEXT:    [[TMP5:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, i64 [[TMP4]], i32 4, i64 4, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[VAL]], i32 8, i64 8, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i64 [[VAL]], ptr [[TMP0]], align 8
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, i64 [[VAL]], i32 8, i64 8, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP4:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, i64 [[TMP2]], i32 8, i64 8, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP4:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i32 16, i64 8, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP1]], i32 4, i64 4, i32 2, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store float [[VAL]], ptr [[TMP2]], align 4
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, i64 [[TMP1]], i32 4, i64 4, i32 2, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP3:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i32 4, i64 4, i32 2, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP4:%.*]] = load float, ptr [[TMP3]], align 4
; CHECK-NEXT:    [[TMP5:%.*]] = bitcast float [[TMP4]] to i32
; CHECK-NEXT:    [[TMP6:%.*]] = zext i32 [[TMP5]] to i64
; CHECK-NEXT:    [[TMP7:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, i64 [[TMP6]], i32 4, i64 4, i32 2, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, i64 [[TMP0]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store double [[VAL]], ptr [[TMP1]], align 8
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, i64 [[TMP0]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 8
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP3:%.*]] = load double, ptr [[TMP2]], align 8
; CHECK-NEXT:    [[TMP4:%.*]] = bitcast double [[TMP3]] to i64
; CHECK-NEXT:    [[TMP5:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, i64 [[TMP4]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 16
; CHECK-NEXT:    [[TMP4:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, i32 10, i64 16, i32 4, i32 0, i8 1, i8 0)
