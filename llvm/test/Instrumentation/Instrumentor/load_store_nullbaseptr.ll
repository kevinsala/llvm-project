...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, ptr null, i64 1, i64 1, i64 1, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i8 1, ptr [[TMP0]], align 1
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, ptr null, i64 1, i64 1, i64 1, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 1
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 1, i64 1, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP2:%.*]] = load i8, ptr [[TMP1]], align 1
; CHECK-NEXT:    [[TMP3:%.*]] = zext i8 [[TMP2]] to i64
; CHECK-NEXT:    [[TMP4:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 [[TMP3]], i64 1, i64 1, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, ptr null, i64 2, i64 2, i64 2, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i16 2, ptr [[TMP0]], align 2
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, ptr null, i64 2, i64 2, i64 2, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 2
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 2, i64 2, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP2:%.*]] = load i16, ptr [[TMP1]], align 2
; CHECK-NEXT:    [[TMP3:%.*]] = zext i16 [[TMP2]] to i64
; CHECK-NEXT:    [[TMP4:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 [[TMP3]], i64 2, i64 2, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, ptr null, i64 3, i64 4, i64 4, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i32 3, ptr [[TMP0]], align 4
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, ptr null, i64 3, i64 4, i64 4, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 4, i64 4, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP2:%.*]] = load i32, ptr [[TMP1]], align 4
; CHECK-NEXT:    [[TMP3:%.*]] = zext i32 [[TMP2]] to i64
; CHECK-NEXT:    [[TMP4:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 [[TMP3]], i64 4, i64 4, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, ptr null, i64 4, i64 8, i64 8, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i64 4, ptr [[TMP0]], align 8
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, ptr null, i64 4, i64 8, i64 8, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 8
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 8, i64 8, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP2:%.*]] = load i64, ptr [[TMP1]], align 8
; CHECK-NEXT:    [[TMP3:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 [[TMP2]], i64 8, i64 8, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_store_ind(ptr [[A]], i32 0, ptr null, ptr [[TMP0]], i64 16, i64 8, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store i128 5, ptr [[TMP1]], align 8
; CHECK-NEXT:    call void @__instrumentor_post_store_ind(ptr [[A]], i32 0, ptr null, ptr [[TMP0]], i64 16, i64 8, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 16
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 16, i64 8, i32 12, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP3:%.*]] = load i128, ptr [[TMP2]], align 8
; CHECK-NEXT:    store i128 [[TMP3]], ptr [[TMP0]], align 16
; CHECK-NEXT:    call void @__instrumentor_post_load_ind(ptr [[ARRAYIDX]], i32 0, ptr null, ptr [[TMP0]], i64 16, i64 8, i32 12, i32 0, i8 1, i8 0)
...
; CHECK-SAME: ptr noundef captures(none) initializes((0, 4)) [[A:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, ptr null, i64 1086324736, i64 4, i64 4, i32 2, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store float 6.000000e+00, ptr [[TMP0]], align 4
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, ptr null, i64 1086324736, i64 4, i64 4, i32 2, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 4
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 4, i64 4, i32 2, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr [[TMP1]], align 4
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast float [[TMP2]] to i32
; CHECK-NEXT:    [[TMP4:%.*]] = zext i32 [[TMP3]] to i64
; CHECK-NEXT:    [[TMP5:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 [[TMP4]], i64 4, i64 4, i32 2, i32 0, i8 1, i8 0)
...
; CHECK-SAME: ptr noundef captures(none) initializes((0, 8)) [[A:%.*]]) {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[TMP0:%.*]] = call ptr @__instrumentor_pre_store(ptr [[A]], i32 0, ptr null, i64 4619567317775286272, i64 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store double 7.000000e+00, ptr [[TMP0]], align 8
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[A]], i32 0, ptr null, i64 4619567317775286272, i64 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 8
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP2:%.*]] = load double, ptr [[TMP1]], align 8
; CHECK-NEXT:    [[TMP3:%.*]] = bitcast double [[TMP2]] to i64
; CHECK-NEXT:    [[TMP4:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 [[TMP3]], i64 8, i64 8, i32 3, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP1:%.*]] = call ptr @__instrumentor_pre_store_ind(ptr [[A]], i32 0, ptr null, ptr [[TMP0]], i64 10, i64 16, i32 4, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store x86_fp80 0xK40028000000000000000, ptr [[TMP1]], align 16
; CHECK-NEXT:    call void @__instrumentor_post_store_ind(ptr [[A]], i32 0, ptr null, ptr [[TMP0]], i64 10, i64 16, i32 4, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[ARRAYIDX:%.*]] = getelementptr inbounds nuw i8, ptr [[A]], i64 16
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX]], i32 0, ptr null, i64 10, i64 16, i32 4, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP3:%.*]] = load x86_fp80, ptr [[TMP2]], align 16
; CHECK-NEXT:    store x86_fp80 [[TMP3]], ptr [[TMP0]], align 16
; CHECK-NEXT:    call void @__instrumentor_post_load_ind(ptr [[ARRAYIDX]], i32 0, ptr null, ptr [[TMP0]], i64 10, i64 16, i32 4, i32 0, i8 1, i8 0)
