...
; CHECK-NEXT:    [[TMP16:%.*]] = call i64 @__instrumentor_pre_alloca(i64 [[TMP1]], i64 16)
; CHECK-NEXT:    [[VLA:%.*]] = alloca i8, i64 [[TMP16]], align 16
; CHECK-NEXT:    [[TMP2:%.*]] = call ptr @__instrumentor_post_alloca(ptr [[VLA]], i64 [[TMP1]], i64 16)
; CHECK-NEXT:    [[TMP21:%.*]] = call ptr @__instrumentor_post_base_pointer_info(ptr [[TMP2]], i32 2)
...
; CHECK-NEXT:    [[TMP12:%.*]] = call ptr @__instrumentor_pre_store(ptr [[ARRAYIDX_EPIL]], i32 0, ptr [[TMP21]], i64 [[TMP4]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store double [[MUL_EPIL]], ptr [[TMP12]], align 8
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[ARRAYIDX_EPIL]], i32 0, ptr [[TMP21]], i64 [[TMP4]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP14:%.*]] = call ptr @__instrumentor_pre_load(ptr [[ARRAYIDX1]], i32 0, ptr [[TMP21]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    [[TMP5:%.*]] = load double, ptr [[TMP14]], align 8
; CHECK-NEXT:    [[TMP10:%.*]] = bitcast double [[TMP5]] to i64
; CHECK-NEXT:    [[TMP18:%.*]] = call i64 @__instrumentor_post_load(ptr [[ARRAYIDX1]], i32 0, ptr [[TMP21]], i64 [[TMP10]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP11:%.*]] = call ptr @__instrumentor_pre_store(ptr [[ARRAYIDX]], i32 0, ptr [[TMP21]], i64 [[TMP6]], i32 8, i64 16, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store double [[MUL]], ptr [[TMP11]], align 16
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[ARRAYIDX]], i32 0, ptr [[TMP21]], i64 [[TMP6]], i32 8, i64 16, i32 3, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP13:%.*]] = call ptr @__instrumentor_pre_store(ptr [[ARRAYIDX_1]], i32 0, ptr [[TMP21]], i64 [[TMP7]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store double [[MUL_1]], ptr [[TMP13]], align 8
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[ARRAYIDX_1]], i32 0, ptr [[TMP21]], i64 [[TMP7]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP15:%.*]] = call ptr @__instrumentor_pre_store(ptr [[ARRAYIDX_2]], i32 0, ptr [[TMP21]], i64 [[TMP8]], i32 8, i64 16, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store double [[MUL_2]], ptr [[TMP15]], align 16
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[ARRAYIDX_2]], i32 0, ptr [[TMP21]], i64 [[TMP8]], i32 8, i64 16, i32 3, i32 0, i8 1, i8 0)
...
; CHECK-NEXT:    [[TMP17:%.*]] = call ptr @__instrumentor_pre_store(ptr [[ARRAYIDX_3]], i32 0, ptr [[TMP21]], i64 [[TMP9]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
; CHECK-NEXT:    store double [[MUL_3]], ptr [[TMP17]], align 8
; CHECK-NEXT:    call void @__instrumentor_post_store(ptr [[ARRAYIDX_3]], i32 0, ptr [[TMP21]], i64 [[TMP9]], i32 8, i64 8, i32 3, i32 0, i8 1, i8 0)
